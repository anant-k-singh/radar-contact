...
export const VABB_STARS: readonly StarSpec[] = [
  {
    ...
    fixes: [
      ...
      { name: 'EMROS', at: F.EMROS, altitudeFt: 6000, speedKts: 210 },
  ...
  },
  {
    ...
    fixes: [
      ...
      { name: 'EMROS', at: F.EMROS, altitudeFt: 8000, speedKts: 210 },
  ...
  },
  {
    ...
    fixes: [
      ...
      { name: 'LIKTA', at: F.LIKTA, altitudeFt: 8000, speedKts: 210 },
  ...
  },
  {
    ...
    fixes: [
      ...
      { name: 'LIKTA', at: F.LIKTA, altitudeFt: 6000, speedKts: 210 },
